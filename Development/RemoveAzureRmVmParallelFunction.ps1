Function Remove-AzureRMVMInstanceParallel { 
    [cmdletbinding(SupportsShouldProcess,ConfirmImpact='High')] 
     Param ( 
        ...
        # A configuration setting to also delete public IP's, on by default 
        $RemovePublicIP = $true 
     ) 
            ...
            Start-Job -ScriptBlock { 
                ...
                Try { 
                    ...
                    #{ 
                        ...
                        if($ManagedDisk) { 
                            #DELETE MANAGEDDISKS 
                           ($OSDisk + $DataDisks) | Where-Object {$_} | ForEach-Object { 
                            ...
                            #DELETE DATA DISKS  
                            $saname = ($VM.StorageProfile.OsDisk.Vhd.Uri -split '\.' | Select-Object -First 1) -split '//' |  Select-Object -Last 1 
