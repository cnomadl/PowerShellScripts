    ...
    $jobs = Get-AzureRmVM -ResourceGroupName $ResourceGroup | Where-Object Name -Match $VmName | ForEach-Object {
        ...
        Start-Job -ScriptBlock {
            try {
                ...
                Write-Output "Connected to $($ctx.Context.Subscription.Name)" -Verbose
                Write-Output "The following resources were found:"
                ...
                Write-Output "Deleting VM:[$($VmName.Name)] from Resource Group:[$resourceGroup]"
